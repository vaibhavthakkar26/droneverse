...
export default async function Home() {
  ...
  try {
    ...
    const partners = partnersData.status === 'fulfilled' ? partnersData.value : [];
          ...
          <div className="text-center">
            ...
            <div className="mt-4 p-4 bg-gray-100 rounded">
              <p className="text-sm text-gray-500">
                <strong>API Base URL:</strong> {getApiBaseUrl()}<br />
                <strong>Using Dummy Data:</strong> {shouldUseDummyData() ? 'Yes' : 'No'}<br />
        ...
        {page.about && (
          <AboutSection
            ...
            fallbackData={{
              ...
              description: "We are a company that values innovation and creativity. DroneVerse is India's leading drone training and defence solutions provider, committed to excellence in everything we do.",
              services: [
        ...
        {page.defence && (
          <DefenceSection
            ...
            fallbackData={{
              ...
              description: "Advanced drone defence systems for modern security challenges"
            }}
          />
        )}
        ...
        {page.training && (
          <Training
            ...
            fallbackData={{
              ...
              description: "Comprehensive drone training programs for all skill levels"
            }}
          />
        )}
