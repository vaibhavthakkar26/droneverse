                ...
                <div className="relative grid grid-cols-2 gap-4 lg:w-1/2">
                    ...
                    <div className="relative flex justify-start col-start-1 row-start-1">
                        <Image
                            ...
                            className="relative z-10 object-contain w-full top-14 lg:top-16 md:top-24 md:left-12 left-9 lg:left-14 xl:left-20"
                        />
                    </div>
                    ...
                    <div className="relative flex justify-end col-span-2 col-start-2 row-start-2">
                        <Image
                            src={dgca3}
                            alt="Drone Practice"
                            className="relative z-0 object-contain w-full md:-top-14 md:-left-1/5 -top-9 -left-1/6 lg:-top-1/2 xl:-top-16"
                        />
                    </div>
                </div>
            </section>
