...
const HoursSection = () => {
  ...
  const dvHorusData = {
    ...
    keyFeatures: [
      {
        ...
        desc: "Secure live footage streaming with global access via AES-256 encrypted links.",
      },
      {
        keyIcon: featureIcon,
        title: "Covert Operation",
        desc: "Ultra-low sound and visibility profile.",
      },
      {
        keyIcon: featureIcon,
        title: "Payload Flexibility",
        desc: "Modular design to support customer-specific payloads.",
      },
      {
        keyIcon: featureIcon,
        title: "All-Weather Performance",
        desc: "Operates in wind gusts up to 45 knots.",
      },
      {
        keyIcon: featureIcon,
        title: "GNSS-Denied Navigation",
        desc: "Functions in denied environments via dead reckoning and autonomous GPS-based navigation.",
      },
      {
        keyIcon: featureIcon,
        title: "Flexible Control Options",
        desc: "Compatible with handheld controllers, FPV goggles, or laptop-based command stations.",
      },
      {
        keyIcon: featureIcon,
        title: "Secure Communications",
        desc: "Equipped with UAVTEK’s proprietary AES-256 encrypted radio system.",
      },
      {
        keyIcon: featureIcon,
        title: "Network Versatility",
        desc: "Adaptable to cellular networks, MANET radio modules, and satellite links for reliable urban and remote operations.",
      },
    ],
    ...
    technicalSpecifications: [
      ...
      {
        label: 'Dimensions (Overall Size with 9" Arms)',
        value: "531mm (L) x 497mm (W) x 80mm (H)",
      },
      { label: "Aircraft Weight (with standard batteries)", value: "1.2 kg" },
      {
        label: 'Aircraft Payload (9" Arms - Max)',
        value: "1.5 kg (affects flight time)",
      },
      { label: "Flight Time", value: "Up to 29 mins" },
      {
        label: "Max Windspeed",
        value: "35 knots (gusting 45 knots), Beaufort 9",
      },
      { label: "Operating Temperature Range", value: "-20°C to +50°C" },
      {
        label: "Launch/Recovery Options",
        value: "Hand / Ground / Vehicle / Boat",
      },
      { label: "Frequency (UAVTEK Link)", value: "5.8 GHz" },
      { label: "Autonomous Mission Capability", value: "Yes" },
      {
        label: "UAVTEK Link Range",
        value: "16 km (handheld controller) / 55 km (optional antenna)",
      },
      {
        label: "GNSS Capability",
        value: "Operational in denied/spoofed environments",
      },
      {
        label: "Electronic Warfare Resistance",
        value: "Undefeated by C-UAS guns & most C-UAS systems",
      },
  ...
  return (
    <>
      ...
      >
        <div
          className="absolute -z-10 inset-0 bg-gradient-to-b 
    ...
    to-white to-[100%]  h-20"
        ...
        <div className="relative">
          <Image
            src={rightFlap}
            alt="right flap"
            className="absolute hidden right-0 bottom-auto md:block object-contain md:w-12   lg:w-16 lg:top-[520px] md:top-[620px] "
          />
        </div>
        <div className="relative">
          <Image
            src={dvhoursDrone}
            alt="dv Hours Drone"
            className="absolute right-0 object-contain w-2/5 lg:top-12 top-20"
          />
        </div>
        ...
        <div className="relative px-4 pt-32 mx-auto pb-36 max-w-7xl md:px-6 lg:px-8 z-[1]">
          <AnimatedWrapper>
            <div className="w-full mb-5 md:w-3/4 lg:w-2/3 lg:mb-8 md:mb-6">
              <h4 className="mb-4 text-sm text-black/70 lg:text-base poppins-medium">
                {dvHorusData.subtitle}
              </h4>
              <h2 className="mb-10  text-4xl md:text-5xl lg:text-[64px] poppins-extrabold tracking-widest">
                {dvHorusData.title}
              </h2>
              <p className="text-sm text-black/70 md:text-base poppins-regular">
                {dvHorusData.description}
              </p>
            </div>
          </AnimatedWrapper>
