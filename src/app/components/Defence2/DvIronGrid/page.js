...
const IronGridSection = () => {
  ...
  return (
    <>
      <section
        className="relative pt-10 bg-black bg-center bg-repeat-y bg-size-[100%] mix-blend-luminosity bg-blend-luminosity"
          ...
          <div className="grid grid-cols-12">
            <div className="relative row-start-1 mb-10 md:col-span-5 lg:col-span-4 lg:row-span-2 col-span-full md:mb-0">
              <Image
                src={IrongridTwin}
                alt="ironGrid twin"
                className=" lg:w-[415px] lg:h-[437px] w-full mix-blend-multiply "
              />
            </div>
            <div className="md:row-start-1 md:col-start-6 md:col-span-6 lg:col-start-5 lg:col-span-8 col-span-full">
              <AnimatedWrapper>
                <h4 className="mb-4 text-sm text-white lg:text-base poppins-medium">
                  {IronGridData.subtitle}
                </h4>

                <h2 className="mb-10 text-white  text-4xl md:text-5xl lg:text-[64px] poppins-extrabold tracking-widest">
                  {IronGridData.title}
                </h2>
                <p className="text-sm text-white md:text-base poppins-regular">
                  {IronGridData.description}
                </p>
              </AnimatedWrapper>
            </div>
            ...
            <div className="col-span-12 md:row-start-2 lg:col-start-5 lg:col-span-8">
              <div className="grid grid-cols-1 gap-2 mt-6 md:gap-4 md:grid-cols-2">
                {IronGridData.highlights.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 text-sm text-white md:text-base poppins-regular"
                  >
                    <img
                      src={item.icon.src}
                      alt={item.text}
