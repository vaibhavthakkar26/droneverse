  ...
  return (
    <>
      <section className="relative overflow-hidden bg-center bg-no-repeat bg-cover"
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/30 from-0% to-black/100 to-100% w-full h-full"></div>
        ...
        <div className='relative px-4 pt-24 mx-auto max-w-7xl md:px-6 lg:px-8'>
          <div className='flex flex-col gap-4'>
            <div className='lg:w-4/5'>
              <h2 className='w-full text-3xl leading-tight text-white uppercase sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl poppins-bold'>Vehicle Mounted
            ...
            <div className='flex items-center justify-center'>
              <div className='w-1/4 -me-8 sm:-me-14 md:-me-20 lg:-me-28 xl:-me-32'>
              ...
              <div className='w-1/4 -ms-8 sm:-ms-14 md:-ms-20 lg:-ms-28 xl:-ms-32'>
