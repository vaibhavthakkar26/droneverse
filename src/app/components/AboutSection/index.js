...
const AboutSection = ({ data }) => {
  ...
  console.log(
    "AboutSection backgroundVideo from API:",
    aboutData?.backgroundVideo
  );
  ...
  const backgroundVideo = getImageFallback(
    aboutData?.backgroundVideo,
    "about",
    "backgroundVideo"
  );
      ...
      <div className={styles.aboutUsBg}>
        ...
        <section className={styles.aboutContainer}>
          ...
          <div className={styles.buttonGroup}>
            ...
            <button className={styles.whiteBtn}>{buttons.getInTouch}</button>
          </div>
        </section>
      </div>
    </>
